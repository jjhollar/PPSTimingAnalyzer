...
// Wed Aug 10 20:46:05 2022 by ROOT version 6.24/07
// from TTree ntp1/ntp1
// found on file: output_ZeroBias.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_ZeroBias.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_ZeroBias.root");
      }
